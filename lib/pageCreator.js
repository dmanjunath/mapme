...
var fs = require('fs');
var pageSettings = require('./pageConfig.js');
...
pageCreator.prototype.writeToFile = function(){
  var writeStream = fs.createWriteStream(this.writefile,'w');
...
function getHeadString(){         //generate the head of the html element
  ...
  \n}\
  \n.node circle {\
  \nstroke: '+pageSettings.strokeColor+';\
  \nstroke-width: '+pageSettings.strokeWidth+';\
  \n}\
  \n.node text {\
  ...
  \n.link {\
  \nfill: none;\
  \nstroke: '+pageSettings.linkColor+';\
  \nstroke-width: '+pageSettings.linkWidth+';\
  \n}\
  \n</style>\
...
\n  var i = 0,duration = '+pageSettings.duration+',root;\
...
\n    .attr("r", 10)\
\n    .style("fill", function(d) { return d._children ? "'+pageSettings.closedColor+'" : "'+pageSettings.openColor+'"; });\
\n\
